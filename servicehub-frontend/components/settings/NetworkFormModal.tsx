...
/**
 * Modale de création/modification d'un réseau (Bootstrap Modal +
 ...
 * conservée ouverte).
 */
export default function NetworkFormModal({ mode, network, onClose, onSubmit }: NetworkFormModalProps) {
  const titleId = "network-form-modal-title";
  ...
  return (
    <ModalShell
      titleId={titleId}
      title={mode === "create" ? "Créer un réseau" : "Modifier le réseau"}
      onClose={onClose}
      footer={
        <>
        ...
        <div className="row g-3">
          ...
          <div className="col-12">
            ...
            <textarea
              ...
              rows={2}
              placeholder="Réseau interne, DMZ, interconnexion partenaire..."
