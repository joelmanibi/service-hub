...
/**
 * Table `technologies` — référentiel générique (module settings).
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addIndex('technologies', ['name']);
    await queryInterface.addIndex('technologies', ['code']);
  },
